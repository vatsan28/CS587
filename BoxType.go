...
func (e *Encoder) myBox(v *MyBox) (err os.Error){
     
     if _, _, error := e.t.PointerCheck(unsafe.Pointer(v), "6f1f2e59d6e1a9afa084da736ca6001b2ff799f151456b0188cc700ecf53553a8ea17c938bbf94ca9f71e6e020bfc4f6e13ef43438bd91b0b0118788b3ce0197", uint64(unsafe.Sizeof(*v))); error == nil {
...
func (e *Encoder) myBoxInternal(v *MyBox) (err os.Error){
...
func (d *Decoder) myBox() (v *MyBox, error os.Error){
...
func (d *Decoder) myBoxInternal() (v *MyBox, error os.Error){
...
func (e *Encoder) any(a Any) (err os.Error){
     ...
     case MyBox:
     	hashByte, err := hex.DecodeString("6f1f2e59d6e1a9afa084da736ca6001b2ff799f151456b0188cc700ecf53553a8ea17c938bbf94ca9f71e6e020bfc4f6e13ef43438bd91b0b0118788b3ce0197")
	if err != nil {
	   return err
	}
     	// hashByte := []byte("6f1f2e59d6e1a9afa084da736ca6001b2ff799f151456b0188cc700ecf53553a8ea17c938bbf94ca9f71e6e020bfc4f6e13ef43438bd91b0b0118788b3ce0197")
     	// e.string("6f1f2e59d6e1a9afa084da736ca6001b2ff799f151456b0188cc700ecf53553a8ea17c938bbf94ca9f71e6e020bfc4f6e13ef43438bd91b0b0118788b3ce0197")
...
func (d *Decoder) any() (retValue *Any, error os.Error) {
     ...
     case bytes.Equal(encodedHash, []byte("6f1f2e59d6e1a9afa084da736ca6001b2ff799f151456b0188cc700ecf53553a8ea17c938bbf94ca9f71e6e020bfc4f6e13ef43438bd91b0b0118788b3ce0197")):
...
func (t *MyBox) IpcWrite(serviceName string, hostname string) (syscall.Fd, syscall.Status) {
	serviceFd, status := goodmiddleman.OpenDirectoryPath("/services/" + serviceName)
	if status != syscall.StatusOk {
		log.Fatalf ("Error calling OpenDirectory /services/%s: %v\n", serviceName, status)
		return 0, status
	...
	netFd, status := goodmiddleman.IpcRepeat(serviceFd, sName, hostname, nil)
	if status != syscall.StatusOk {
		log.Fatalf ("Error calling IpcWriteMyBox: %v\n", status)
		return 0, status
	}
	writer := goodmiddleman.NewWriter(netFd)
	goodmiddleman.Close(serviceFd)
...
func (t *MyBox) Write(fd syscall.Fd) (syscall.Status) {
...
func (t *MyBox) WriteVar(path string) (syscall.Status) {
...
func (t *MyBox) Read(fd syscall.Fd) (syscall.Status) {
...
func (t *MyBox) ReadVar(path string) (syscall.Status) {
	fd, name, status := goodmiddleman.OpenPathLastDirectory(path)
	if status != syscall.StatusOk {
		return status
	}
...
func (t *MyBox) CreateDirectory(fd syscall.Fd, name string, label string) (syscall.Status) {
       hash := goodmiddleman.HashValue{ 0x6f,0x1f,0x2e,0x59,0xd6,0xe1,0xa9,0xaf,0xa0,0x84,0xda,0x73,0x6c,0xa6,0x00,0x1b,0x2f,0xf7,0x99,0xf1,0x51,0x45,0x6b,0x01,0x88,0xcc,0x70,0x0e,0xcf,0x53,0x55,0x3a,0x8e,0xa1,0x7c,0x93,0x8b,0xbf,0x94,0xca,0x9f,0x71,0xe6,0xe0,0x20,0xbf,0xc4,0xf6,0xe1,0x3e,0xf4,0x34,0x38,0xbd,0x91,0xb0,0xb0,0x11,0x87,0x88,0xb3,0xce,0x01,0x97, }  
       return goodmiddleman.CreateDirectory(fd, name, label, hash)
}

func (t *MyBox) CreateDirectoryPath(path string, label string) (syscall.Status) {
       hash := goodmiddleman.HashValue{ 0x6f,0x1f,0x2e,0x59,0xd6,0xe1,0xa9,0xaf,0xa0,0x84,0xda,0x73,0x6c,0xa6,0x00,0x1b,0x2f,0xf7,0x99,0xf1,0x51,0x45,0x6b,0x01,0x88,0xcc,0x70,0x0e,0xcf,0x53,0x55,0x3a,0x8e,0xa1,0x7c,0x93,0x8b,0xbf,0x94,0xca,0x9f,0x71,0xe6,0xe0,0x20,0xbf,0xc4,0xf6,0xe1,0x3e,0xf4,0x34,0x38,0xbd,0x91,0xb0,0xb0,0x11,0x87,0x88,0xb3,0xce,0x01,0x97, }
